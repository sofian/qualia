...
Observation* OscRLEnvironment::readObservation(observation_t* buffer) {
  memcpy(currentObservation.observations, buffer, observationDim*sizeof(observation_t));
  currentObservation.reward = buffer[observationDim];
